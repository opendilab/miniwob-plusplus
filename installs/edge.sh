...
pip install requests &&
  STABLE_VERSION=$(python -c 'import requests;print(requests.get("https://huggingface.co/HansBug/browser_drivers_mirror/resolve/main/edge/LATEST_STABLE").content.decode("utf-16").strip());') &&
